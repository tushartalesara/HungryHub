...
//        var pencoder = context.getBean(PasswordEncoder.class);
//        System.out.println(pencoder.encode("password123"));
//        System.out.println(pencoder.encode("mypassword123"));
//        System.out.println(pencoder.encode("secret456"));
//        System.out.println(pencoder.encode("dbms@123"));


//         UserJdbcDao userJdbcDao = context.getBean(UserJdbcDao.class);
//         User admin = userJdbcDao.getUserById(100);
//         System.out.println(admin);
//         User someone = userJdbcDao.getUserById(1);
